...
public class SaleThird extends JFrame {
	...
	public SaleThird() {
		...
		//	JComboBox comboBox_4 = new JComboBox();
			...
			JButton button = new JButton("\u0646\u0645\u0627\u06CC\u0634 \u0628\u06CC\u0645\u0627\u0631\u0627\u0646");
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					String[] columns = new String[] {
							"Id", "Date","Family", "Name","PatientInsuriceId"  };
					...
					pane.setBorder(BorderFactory.createTitledBorder ("Patients"));
